...
//const listarEstadosJason = {}

const getLIstaDeEstado = function () {
    let listaEstadosJason = {}
    listaEstadosJason.uf = estadosCidades


    //console.log(listarEstadosJason.uf.estados)
    let cidades = estadosCidades.estados
    //console.log(cidades)




    let qntCidade = estadosCidades.estados.length
    //let qntCidade = estadosCidades.estados.sigla.length
    //console.log(qntCidade)
    //console.log(estadosCidades.estados[1].sigla)

    for (let cont = 0; cont < qntCidade; cont++) {
        //listaArray.push(estadosCidades.estados.sigla)

        let estados = estadosCidades.estados[cont].sigla

        const teste = JSON.stringify(estados)
        console.log(teste)
    }

    //  estadosCidades.estados.forEach(function(dados) {
    //      console.log(dados.sigla)
    //  })
}
...
const getDadosEstados = function (estado) {
    ...
    estadosCidades.estados.forEach(function (estados) {
        ...
        let capital = estados.capital
        let regiao = estados.regiao
...
const getCapitalEstados = function (capital) {
    ...
    estadosCidades.estados.forEach(function (capitais) {
        let uf = capitais.sigla
        let desscricao = capitais.nome
        let capital = capitais.capital
    ...
    let CapitalFiltrado = novoArray.filter(function (objeto) {
        return objeto.uf === capital.toUpperCase();
    });

    console.log(CapitalFiltrado);


}

//getCapitalEstados('ac')
...
//     let novoArray = []
//     estadosCidades.estados.forEach(function (regioes) {
//         let uf = regioes.sigla
//         let desscricao = regioes.nome
...
//         arrayComTodos.push(regiaoEscolida)
//     })

//     let CapitalFiltrado = regiaoEscolida.filter(function (objeto) {
//         return objeto.regiao === regiao.toUpperCase();
//     });
